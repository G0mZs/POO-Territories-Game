...
${OBJECTDIR}/Eventos.o: Eventos.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Eventos.o Eventos.cpp
...
${OBJECTDIR}/Inicial.o: Inicial.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Inicial.o Inicial.cpp

${OBJECTDIR}/Tecnologia.o: Tecnologia.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tecnologia.o Tecnologia.cpp
...
${OBJECTDIR}/imperio.o: imperio.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/imperio.o imperio.cpp
